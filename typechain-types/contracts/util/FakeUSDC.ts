...
export interface FakeUSDCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface FakeUSDC extends BaseContract {
  connect(runner?: ContractRunner | null): FakeUSDC;
  ...
  mintOnce: TypedContractMethod<[to: AddressLike], [void], "nonpayable">;
